 ...
 %>
		...
		<%
			...
			eventos = buscas.getEventos(
					...
					"SELECT id, nome_curto, tags FROM evento e INNER JOIN usuarios_eventos e2 ON e.id = e2.id_eve WHERE NOT EXISTS (SELECT 1 FROM usuarios_eventos WHERE id_usu = "
			...
			<br /> <br />-->
				<div class="container">
					...
					<div class="slide">
						...
						<%
							eventos = buscas.getEventos(
									"SELECT id, nome_curto, tags FROM evento e WHERE NOT EXISTS (SELECT 1 FROM usuarios_eventos WHERE id_usu = "
