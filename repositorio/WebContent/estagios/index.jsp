...
<body>
	...
	<div class="container">
		<h2 class="tit">Ofertas de estágio</h2>
		<br />
 ...
 %>
		...
		<%
			...
			estagios = buscas.getEstagio(
					...
					"SELECT id, funcao, tags FROM estagio e INNER JOIN usuarios_estagio e2 ON e.id = e2.id_eve WHERE NOT EXISTS (SELECT 1 FROM usuarios_estagio WHERE id_usu = "
			...
			<br /> <br />-->
				<div class="container">
					...
					<div class="slide">
						...
						<%
							estagios = buscas.getEstagio(
									"SELECT id, funcao, tags FROM estagio e WHERE NOT EXISTS (SELECT 1 FROM usuarios_estagio WHERE id_usu = "
